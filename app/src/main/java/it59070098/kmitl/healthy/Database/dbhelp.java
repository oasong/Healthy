package it59070098.kmitl.healthy.Database;
...
import it59070098.kmitl.healthy.sleepitem;
...
public class dbhelp extends SQLiteOpenHelper {
    ...
    public void insertSleepTime(sleepitem sleepTimeItem) {
        // get database
    ...
    public ArrayList<sleepitem> getAllItem() {
        SQLiteDatabase db = this.getReadableDatabase();
        ArrayList<sleepitem> sleepTimeItems = new ArrayList<>();
    ...
    public void update(sleepitem item) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues row = new ContentValues();
